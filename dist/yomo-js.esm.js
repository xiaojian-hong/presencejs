...
var YoMoClient = /*#__PURE__*/function (_Subject) {
  ...
  function YoMoClient(url, option) {
    ...
    _this.connectionStatus$ = new Subject();
  ...
  _proto.on = function on(event, cb) {
    this.pipe(filter(function (message) {
  ...
  _proto.reconnect = function reconnect(url, option) {
    ...
    this.reconnectionObservable = interval(this.reconnectInterval).pipe(takeWhile(function (_, index) {
...
export { YoMoClient };
//# sourceMappingURL=yomo-js.esm.js.map
